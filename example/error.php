...
<head>
    ...
    <title>Ringcaptcha Verification FAILED!!</title>
...
<body id="main_body" >
    ...
    <div id="form_container">
        <h1><a>Ringcaptcha Verification FAILED!!</a></h1>
        <form id="form_240153" class="appnitro"  method="post" action="">
            <div class="form_description">
                <h2>Ringcaptcha Verification FAILED!!</h2>
            </div>
            <p>Error Message: <strong><?php echo $message ?></strong></p>
            <ul>
